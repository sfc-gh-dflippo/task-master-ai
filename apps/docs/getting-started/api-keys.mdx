...
- **CLI Providers**: Gemini CLI, Grok CLI, Cortex Code, and Claude Code use OAuth/CLI config instead of API keys
- **Snowflake**: Requires both `SNOWFLAKE_API_KEY` and `SNOWFLAKE_BASE_URL` configuration
