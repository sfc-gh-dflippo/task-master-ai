...
- **Format**: Programmatic Access Token (PAT) or OAuth token
- **Required**: ✅ **Yes**
- **Models**: Claude, OpenAI, Llama, Mistral, DeepSeek, and other Cortex models
- **Requirements**: Also requires `SNOWFLAKE_BASE_URL` configuration
- **Models**: [Snowflake Cortex Model Availability](https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-rest-api#model-availability)
- **Get Token**: [Snowflake PAT Documentation](https://docs.snowflake.com/en/sql-reference/sql/alter-user-add-programmatic-access-token)
- **Authentication**: [REST API Authentication](https://docs.snowflake.com/en/developer-guide/snowflake-rest-api/authentication)
...
- **Snowflake Cortex**: Requires both `SNOWFLAKE_API_KEY` (Programmatic Access Token or OAuth) and `SNOWFLAKE_BASE_URL` configuration
